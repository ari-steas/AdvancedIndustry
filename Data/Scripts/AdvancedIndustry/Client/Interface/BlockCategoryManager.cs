...
namespace AdvancedIndustry.Client.Interface
{
    public static class BlockCategoryManager
    {
        ...
        public static void Init()
        {
            ...
            _blockCategory = new GuiBlockCategoryHelper("[AdvancedIndustry]", "AdvancedIndustryBlockCategory");
        ...
        public static void RegisterFromDefinition(AssemblyBlockDefinition definition)
        {
