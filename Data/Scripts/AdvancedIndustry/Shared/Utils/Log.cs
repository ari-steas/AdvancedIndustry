...
namespace AdvancedIndustry.Shared.Utils
{
    public static class Log
    {
        ...
        private const string ModName = "AdvancedIndustry";
        ...
        public static void Init(IMyModContext context)
        {
            ...
            MyLog.Default.WriteLineAndConsole($@"[{ModName}] - Debug log can be found in %AppData%\Roaming\SpaceEngineers\Storage\AdvancedIndustry.log");
        }
        ...
        private class CustomCrashModContext : IMyModContext
        {
            ...
            public static ModCrashedException GenerateException(string source, Exception ex)
            {
                var context = new CustomCrashModContext(Log._modContext,
                    ...
                    "Mod: %AppData%\\SpaceEngineers\\Storage\\AdvancedIndustry.log \n" +
